...
const HelpRequestPage = () => {
    ...
    const renderData = () => {
        return <Fragment>
            <Typography variant={'h5'} sx={{mb: 3, opacity: '87%'}}>Сбор средств для пенсионерки Ангелины
                Ивановны </Typography>
            <Box sx={{mb: 3}}>
                ...
                <Box sx={{display: 'flex', alignItems: 'center'}}>
                    <VerifiedIcon color={'info'} style={{fontSize: '20px'}}/><Typography variant={'caption'} sx={{
                    ml: 0.5,
                    display: 'flex',
                    alignItems: 'center'
                }}>Организация проверена</Typography>
                </Box>
            </Box>
            <Box sx={{mb: 3}}>
                <Typography variant={'h6'} sx={{mb: 1}}>Кому мы помогаем</Typography>
                <Typography variant={'body2'}>Мы помогаем пенсионерке Ангелине Инвановне. Ей 82 года, и, к сожалению, её
                    здоровье
            ...
            <Box sx={{mb: 3}}>
                ...
                <Typography variant={'body2'}>Оплатить лечение МКБ в клинике "Здоровье". Купить одежду на зимний сезон.
                    Пополнить
            ...
            <Box sx={{mb: 3}}>
                ...
                <Stack gap={1}>
                    <Typography display={"flex"} alignItems={"center"} variant="body2"><CheckCircleOutlineIcon
                        color={'disabled'} sx={{mr: 0.5}}/>Оплатить лечение МКБ в клинике “Здоровье”</Typography>
                    <Typography display={"flex"} alignItems={"center"} variant="body2"><CheckCircleOutlineIcon
                        color={'disabled'} sx={{mr: 0.5}}/> Провести диагностику онкологических заболеваний</Typography>
                    <Typography display={"flex"} alignItems={"center"} variant="body2"> <CheckCircleOutlineIcon
                        color={'disabled'} sx={{mr: 0.5}}/>Купить одежду на зимний сезон</Typography>
                    <Typography display={"flex"} alignItems={"center"} variant="body2"> <CheckCircleOutlineIcon
                        color={'success'} sx={{mr: 0.5}}/>Обеспечить уход на дому в течении полугода</Typography>
                    <Typography display={"flex"} alignItems={"center"} variant="body2"> <CheckCircleOutlineIcon
                        color={'success'} sx={{mr: 0.5}}/>Восполнить необходимые лекарства</Typography>
                </Stack>
            </Box>
            <Box sx={{mb: 3}}>
